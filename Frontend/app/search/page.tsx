...
import { Activity, Brain, Database, Search, Sparkles, Zap } from "lucide-react"
        ...
        <div className="relative mx-auto max-w-7xl space-y-10">
          <section className="grid gap-8 lg:grid-cols-[1fr_420px] lg:items-end">
            ...
            <div className="rounded-[2rem] border border-border bg-card/80 p-2 shadow-2xl shadow-primary/10 backdrop-blur">
              <form action="/search" className="flex flex-col gap-3 rounded-[1.5rem] border border-border/60 bg-background/70 p-3 sm:flex-row">
                ...
                <button
                  type="submit"
                  className="h-12 rounded-2xl bg-primary px-6 text-sm font-bold text-primary-foreground transition-all hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/25 active:scale-95"
                >
                  Search
                </button>
              </form>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              { label: "Total Signals", value: query ? totalResults : "Ready", icon: Activity },
